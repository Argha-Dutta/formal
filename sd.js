document.addEventListener('DOMContentLoaded', () => {
    ...
    confirmPasswordInput.addEventListener('input', () => {
      ...
      if (password === confirmPassword) {
        passwordMatchStatus.textContent = 'Passwords_match';
        passwordMatchStatus.style.color = 'green';
      } else {
        passwordMatchStatus.textContent = 'Passwords_do_not_match';
    ...
    dobInput.addEventListener('input', () => {
      ...
      if (age < 18) {
        ageStatus.textContent = 'Must_be_18_or_older';
        ageStatus.style.color = 'red';
        submitButton.disabled = true;
      } else {
        ageStatus.textContent = 'Age_is_valid';
